...
void CTerrainInputManager::ProcessInput(HWND& hwnd, CObjectShader* shader)
{
	static UCHAR pKeyBuffer[256];
	if (GetKeyboardState(pKeyBuffer))
	{
...
void CTerrainInputManager::ProcessingMouseMessage(HWND& hWnd, UINT& nMessageID, WPARAM& wParam, LPARAM& lParam)
{
	switch (nMessageID)
	{
	case WM_RBUTTONDOWN:
...
void CTerrainInputManager::ProcessingKeyboardMessage(HWND& hWnd, UINT& nMessageID, WPARAM& wParam, LPARAM& lParam)
{
	switch (nMessageID)
	{
	case WM_KEYDOWN:
...
LRESULT CTerrainInputManager::ProcessingWindowMessage(HWND& hWnd, UINT& nMessageID, WPARAM& wParam, LPARAM& lParam)
{
